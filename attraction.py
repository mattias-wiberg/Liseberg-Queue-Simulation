...
class Attraction:
    def __init__(self, name: str, position: tuple, wagon_size: int, wagon_ride_time: float, n_wagons: int, attraction_coeff: float = 1,
        ...
        self.wagon_arrival_time = round(wagon_ride_time/n_wagons)
    ...
    def advance_queue(self, global_time):
        ...
        if places_left == 0:
            ...
            for i in range(1, self.check_back_limit):
    ...
    def get_queue_time(self):
        ...
        if len(self.__queue_time_history) - 1 - self.delay < 0:
            ...
            # newest - delay
            return self.__queue_time_history[len(self.__queue_time_history) - 1 - self.delay]
